...
export function getSecurityHeaders() {
    ...
    const csp = [
        ...
        "connect-src 'self' https://*.supabase.co https://api.stripe.com https://www.paypal.com https://www.sandbox.paypal.com https://www.google-analytics.com https://*.google-analytics.com https://o4510422575415296.ingest.de.sentry.io",
