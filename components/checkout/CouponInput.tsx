        ...
        <div className="space-y-2">
            ...
            <div className="flex flex-col space-y-2">
                <input
                    ...
                    className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-rose-500 focus:border-transparent uppercase font-mono text-sm ${error ? 'border-red-300' : 'border-gray-300'
                        }`}
                    disabled={loading}
                />
                <button
